...
<div class="container">
	<div class="row">
		...
		<div class="col-md-6 col-sm-6 aneeq_theme_desc">
			...
			<a href="https://awplife.com/wordpress-plugins/aneeq-premium/" target="_blank"  class="button button-primary button-hero load-customize hide-if-no-customize">BUY NOW</a>
		</div>
	</div>
